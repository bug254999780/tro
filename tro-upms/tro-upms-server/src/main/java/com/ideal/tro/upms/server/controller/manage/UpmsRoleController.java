...
public class UpmsRoleController extends BaseController {
    ...
    public Object list(
       ...
       /* UpmsRoleExample upmsRoleExample = new UpmsRoleExample();
        ...
        UpmsRole tUpmsRole = new UpmsRole();
        if (StringUtils.isNotBlank(search)) {
            tUpmsRole.setTitle(search);
        }
        List<UpmsRole> rows = upmsRoleService.selectByExampleForOffsetPage(tUpmsRole, offset, limit);
        int total = upmsRoleService.selectCount(tUpmsRole);
    ...
    public Object create(UpmsRole upmsRole) {
        ...
        int count = upmsRoleService.update(upmsRole);
    ...
    public Object delete(@PathVariable("ids") String ids) {
        int count = upmsRoleService.updateIds(ids);
        return new UpmsResult(UpmsResultConstant.SUCCESS, count);
    }
