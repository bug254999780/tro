...
public class UpmsLogController extends BaseController {
    ...
    public Object list(
      ...
      /*  UpmsLogExample upmsLogExample = new UpmsLogExample();
        ...
        if (StringUtils.isNotBlank(search)) {
            upmsLog.setDescription(search);
        }
        List<UpmsLog> rows = upmsLogService.selectByExampleForOffsetPage(upmsLog, offset, limit);
        int total = upmsLogService.selectCount(upmsLog);
    ...
    public Object delete(@PathVariable("ids") String ids) {
        int count = upmsLogService.updateIds(ids);
