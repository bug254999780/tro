package com.ideal.tro.upms.server.interceptor;
...
public class UpmsInterceptor extends HandlerInterceptorAdapter {
    ...
    private static final String ZHENG_OSS_ALIYUN_OSS_POLICY = PropertiesFileUtil.getInstance("tro-oss-client").get("tro.oss.aliyun.oss.policy");
