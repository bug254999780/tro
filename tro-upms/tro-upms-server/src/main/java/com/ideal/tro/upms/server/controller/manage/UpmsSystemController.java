...
public class UpmsSystemController extends BaseController {
    ...
    public Object list(
        ...
        UpmsSystem tUpmsSystemt = new UpmsSystem();
        if (StringUtils.isNotBlank(search)) {
            tUpmsSystemt.setTitle(search);
        }
        List<UpmsSystem> rows = upmsSystemService.selectByExampleForOffsetPage(tUpmsSystemt, offset, limit);
        int total = upmsSystemService.selectCount(tUpmsSystemt);
    ...
    public Object create(UpmsSystem upmsSystem) {
        ...
        int count = upmsSystemService.save(upmsSystem);
    ...
    public Object delete(@PathVariable("ids") String ids) {
        int count = upmsSystemService.updateIds(ids);
        return new UpmsResult(UpmsResultConstant.SUCCESS, count);
    }
    ...
    public Object update(@PathVariable("id") int id, UpmsSystem upmsSystem) {
        ...
        int count = upmsSystemService.update(upmsSystem);
        return new UpmsResult(UpmsResultConstant.SUCCESS, count);
    }
