package com.ideal.tro.upms.client.util;


import com.ideal.tro.common.util.AESUtil;
...
public class RedisUtil {
	...
	private static Logger _log = LoggerFactory.getLogger(com.ideal.tro.common.util.RedisUtil.class);
	...
	public synchronized static void lpush(String key, String... strings) {
		try {
			Jedis jedis = com.ideal.tro.common.util.RedisUtil.getJedis();
