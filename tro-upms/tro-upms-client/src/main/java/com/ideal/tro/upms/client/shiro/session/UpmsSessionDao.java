package com.ideal.tro.upms.client.shiro.session;

import com.ideal.tro.upms.client.util.RedisUtil;
import com.ideal.tro.upms.common.constant.UpmsConstant;
import com.ideal.tro.upms.client.util.SerializableUtil;
...
public class UpmsSessionDao extends CachingSessionDAO {
    ...
    // 会话key
    private final static String ZHENG_UPMS_SHIRO_SESSION_ID = "tro-upms-shiro-session-id";
    // 全局会话key
    private final static String ZHENG_UPMS_SERVER_SESSION_ID = "tro-upms-server-session-id";
    // 全局会话列表key
    private final static String ZHENG_UPMS_SERVER_SESSION_IDS = "tro-upms-server-session-ids";
    // code key
    private final static String ZHENG_UPMS_SERVER_CODE = "tro-upms-server-code";
    // 局部会话key
    private final static String ZHENG_UPMS_CLIENT_SESSION_ID = "tro-upms-client-session-id";
    // 单点同一个code所有局部会话key
    private final static String ZHENG_UPMS_CLIENT_SESSION_IDS = "tro-upms-client-session-ids";
